...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "UpperTorso", "LowerTorso", "RightUpperArm", "RightLowerArm", "LeftUpperArm", "LeftLowerArm", "RightHand", "LeftHand", "RightUpperLeg", "RightLowerLeg", "LeftUpperLeg", "LeftLowerLeg", "RightFoot", "LeftFoot", "HumanoidRootPart"},
